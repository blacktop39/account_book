...
const ICONS = [
  ...
  { id: "ShoppingCart", icon: ShoppingCart, label: "장바구니" },
  ...
  { id: "Cookie", icon: Cookie, label: "간식" },
  ...
  { id: "Fuel", icon: Fuel, label: "주유" },
  { id: "Wrench", icon: Wrench, label: "정비" },
  ...
  { id: "Zap", icon: Zap, label: "전기" },
  { id: "Droplet", icon: Droplet, label: "수도" },
  { id: "Flame", icon: Flame, label: "가스" },
